/*
  ...
  1. Changes
    ...
    - Create triggers to ensure user_id is never NULL
    - Preserve original user_id during updates

  2. Purpose
    - Fix "null value in column "user_id" violates not-null constraint" errors
    - Ensure data integrity by preventing NULL user_id values
